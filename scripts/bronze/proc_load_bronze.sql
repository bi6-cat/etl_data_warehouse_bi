...
BEGIN
	...
	BEGIN TRY
		...
		--	FIRSTROW = 2
		--);
		INSERT INTO bronze.Patients (patient_id, name, gender, dob, address, phone, email)
		...
		--	FIRSTROW = 2
		--);
		INSERT INTO bronze.Doctors (doctor_id, name, last_name, specialization, phone, email)
		...
		--	FIRSTROW = 2
		--);
		INSERT INTO bronze.Appointments (appointment_id, patient_id, doctor_id, appointment_date, start_time, end_time, reason, status, phone, location, appointment_type)
		...
		--	FIRSTROW = 2
		--);
		INSERT INTO bronze.VitalSigns (vital_id, patient_id, measurement_date, blood_pressure, heart_rate, respiratory_rate, temperature, oxygen_saturation, blood_sugar)
		...
		--	FIRSTROW = 2
		--);
		INSERT INTO bronze.Diseases (disease_id, patient_id, disease_name, diagnosis_date)
		...
		--	FIRSTROW = 2
		--);
		INSERT INTO bronze.Treatments(treatment_id, patient_id, doctor_id, disease_id, treatment_description, treatment_date)
		...
		--	FIRSTROW = 2
		--);
		INSERT INTO bronze.HospitalFees (fee_id, appointment_id, patient_id, service_type, description, amount, fee_date, phone)
		...
		--	FIRSTROW = 2
		--);
		INSERT INTO bronze.Prescriptions (prescription_id, appointment_id, doctor_id, patient_id, medicine_name, form, dosage_mg, instruction, duration_days, note)
