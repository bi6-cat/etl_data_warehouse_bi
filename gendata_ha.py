...
# Data sizes
num_patients = 4000    # 400,000 patients
num_doctors = 10000      # 10,000 doctors
num_records = num_patients * 2  # 800,000 vital signs
num_appointments = num_patients * 3  # 1,200,000 appointments
num_lab_results = num_patients * 2  # 800,000 lab results
...
def generate_age():
    age_dist = np.random.choice(
        ...
        p=[0.05, 0.15, 0.30, 0.40, 0.10]  # Adjusted probabilities
    )
